                            ...
                            <form method="POST" action="{{ route('login') }}" class="space-y-4 md:space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email"
                                        class="{{ $errors->has('email') ? 'bg-red-100 border-red-400 text-red-500 placeholder-red-700' : 'bg-white border-yellow-400 text-gray-900 placeholder-gray-400  focus:ring-yellow-400 focus:border-yellow-400' }} rounded-lg border-1 text-sm mt-3 block w-full p-2.5"
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password" id="password" placeholder="••••••••"
                                        class="{{ $errors->has('password') ? 'bg-red-100 border-red-400 text-red-500 placeholder-red-700' : 'bg-white border-yellow-400 text-gray-900 placeholder-gray-400  focus:ring-yellow-400 focus:border-yellow-400' }} rounded-lg border-1 text-sm mt-3 block w-full p-2.5"
